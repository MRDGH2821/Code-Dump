...
~Exp()
{
  if (op == 'P')
    ...
    cout << "Deleting exp with op " << op << endl;
}
};
spE literal(string s)
{
  return spE(new Exp(s));
}
spE formula(char o, spE l, spE r)
{
  return spE(new Exp(o, l, r));
}
