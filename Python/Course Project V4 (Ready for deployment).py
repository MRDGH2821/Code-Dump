                                                                                                          ...
                                                                                                          def readall() :
                                                                                                            ...
                                                                                                            j = open('student.txt', 'r')  # opening file
                                                                                                                lk = j.readlines()  # reading complete data
                                                                                                                     print('{:6} {:4} {:4} {:4} {:4}'.format('Rollno', 'Name', 'Sub1', 'Sub2', 'Sub3'))
    #printing data in formatted form
                                                                                                                     for c in range(len(lk)) :
                                                                                                                       try :
                                                                                                                         c1 = lk[c].split()
                                                                                                                              print('{:^6} {:^4} {:^4} {:^4} {:^4}'.format(c1[0], c1[1], c1[2], c1[3], c1[4]))
            ...
            ' ''
                ...
                #per =(i[1]+i[2]+i[3])/3
                #Formatting output
                                                                                                                                                                      print('{}\n{}\n{}\n{}\n{}'.format('Rollno:' + i[0], 'Name:' + i[1], 'Sub1:' + i[2], 'Sub2:' + i[3], 'Sub3:' + i[4]))
...
def menu():
    ...
    print(' - 1. Force Backup data(Will close program after backup) ')  # i.e. manually backing up data
    print("0. Exit")
    print("")
...
#Intro Screen
print("\n{:^50}\n\n\n{:^50}\n\n{:^50}".format('Student Records ', 'Project made by : Aniruddha Bhatt ', 'College : Vishwakarma Institutes of Technology '))
sleep(3)
print(' \ n \ n \ n ')
menu()
