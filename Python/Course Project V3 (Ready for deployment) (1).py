...
print(' \ n
                                                                                                                                                                                                       ...
                                                                                                                                                                                                       \ n \ n \ n { : ^ 50 } \ n { : ^ 50 } \ n \ n { : ^ 50 } '.format('Student Records ','Project made by : Mihir Rabade, Manthan Jagadale ','Samruddha Kumbhar, Aayush Mehta ','College : Vishwakarma Institutes of Technology '))
sleep(3)
print(' \ n \ n \ n ')
menu()